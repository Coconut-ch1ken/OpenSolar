"""Comparison policy for Phase 0 claim verification."""
...
from .schemas import BenchmarkClaim, BenchmarkContract, ClaimComparison, ObservedMetric, Phase0VerificationSummary
...
def compare_contract_to_observed(
    ...
    *,
    ...
    expected = _numeric(claim.expected_value)
