...
- Status: `completed`
- Result: `artifacts/autosci/runs/shim-survey-format/map_code_evidence.result.json`
- Evidence: `artifacts/autosci/runs/shim-survey-format/code_evidence_map.json`
- Evidence ledger: `artifacts/autosci/runs/shim-survey-format/evidence.jsonl`
...
- map-001: unknown for claim-001 in artifacts/autosci/runs/shim-survey-format/sample_repo/bridge_fixture.py
