...
- Status: `completed`
- Result: `artifacts/autosci/runs/test-paper-compile-token/map_code_evidence.result.json`
- Evidence: `artifacts/autosci/runs/test-paper-compile-token/code_evidence_map.json`
- Evidence ledger: `artifacts/autosci/runs/test-paper-compile-token/evidence.jsonl`
...
- map-001: unknown for claim-001 in artifacts/autosci/runs/test-paper-compile-token/sample_repo/bridge_fixture.py
