...
- Status: `completed`
- Result: `artifacts/autosci/runs/paper-draft-8035ae7f7a/map_code_evidence.result.json`
- Evidence: `artifacts/autosci/runs/paper-draft-8035ae7f7a/code_evidence_map.json`
- Evidence ledger: `artifacts/autosci/runs/paper-draft-8035ae7f7a/evidence.jsonl`
...
- map-001: unknown for claim-001 in artifacts/autosci/runs/paper-draft-8035ae7f7a/sample_repo/bridge_fixture.py
