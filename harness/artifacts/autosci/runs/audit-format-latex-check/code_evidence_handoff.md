...
- Status: `completed`
- Result: `artifacts/autosci/runs/audit-format-latex-check/map_code_evidence.result.json`
- Evidence: `artifacts/autosci/runs/audit-format-latex-check/code_evidence_map.json`
- Evidence ledger: `artifacts/autosci/runs/audit-format-latex-check/evidence.jsonl`
...
- map-001: unknown for claim-001 in artifacts/autosci/runs/audit-format-latex-check/sample_repo/bridge_fixture.py
