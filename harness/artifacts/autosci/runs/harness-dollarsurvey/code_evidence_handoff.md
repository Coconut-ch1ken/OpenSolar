...
- Status: `completed`
- Result: `artifacts/autosci/runs/harness-dollarsurvey/map_code_evidence.result.json`
- Evidence: `artifacts/autosci/runs/harness-dollarsurvey/code_evidence_map.json`
- Evidence ledger: `artifacts/autosci/runs/harness-dollarsurvey/evidence.jsonl`
...
- map-001: unknown for claim-001 in artifacts/autosci/runs/harness-dollarsurvey/sample_repo/bridge_fixture.py
