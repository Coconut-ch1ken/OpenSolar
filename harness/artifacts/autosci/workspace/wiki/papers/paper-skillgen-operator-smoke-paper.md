...
source_evidence: "artifacts/autosci/runs/audit-format-latex-check/research_paper.json"
...
- Parse status: `parsed`
- Evidence: `artifacts/autosci/runs/audit-format-latex-check/research_paper.json`
