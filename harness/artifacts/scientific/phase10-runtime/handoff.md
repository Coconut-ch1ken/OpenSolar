...
- Status: `completed`
- Result: `artifacts/scientific/phase10-runtime/phase10-runtime-code-map.result.json`
- Evidence: `artifacts/scientific/phase10-runtime/code_evidence_map.json`
- Evidence ledger: `artifacts/scientific/phase10-runtime/evidence.jsonl`

## Paper

- paper-sample-paper: AutoSci Adapter Fixture Paper (plugins/autosci/tests/fixtures/sample_paper.md)
